        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var onlongpress = function (evt) {
                    ...
                    var _touchX = ngDraggable.inputEvent(evt).pageX
                    var _touchY = ngDraggable.inputEvent(evt).pageY
                    _mx = angular.isDefined(_touchX) ? _touchX : ngDraggable.inputEvent(evt).originalEvent.pageX; //ngDraggable.getEventProp(evt, 'pageX');
                    _my = angular.isDefined(_touchY) ?_touchY : ngDraggable.inputEvent(evt).originalEvent.pageY; //ngDraggable.getEventProp(evt, 'pageY');
